...
{	/*Dataset*/				/*cross section*/		/*nGen*/		/*kCol*/		/*Process*/		/*To Use*/
	...
	//MC 2017
	{"DYJetsToLL_HT-70to100_2017",		"175.3*1.23",			"6462960",		"kPink+1",		"DY",			"YES"},/*14*/
	{"DYJetsToLL_HT-100to200_2017",		"147.4*1.23",			"9855000",		"kPink+1",		"DY",			"YES"},/*15*/
	{"DYJetsToLL_HT-200to400_2017",		"40.99*1.23",			"10179000",		"kkPink+1",		"DY",			"YES"},/*16*/
	{"DYJetsToLL_HT-400to600_2017",		"5.678*1.23",			"3318000",		"kPink+1",		"DY",			"YES"},/*17*/
	{"DYJetsToLL_HT-600to800_2017",		"1.367*1.23",			"8225000",		"kPink+1",		"DY",			"YES"},/*18*/
	{"DYJetsToLL_HT-800to1200_2017",	"0.6304*1.23",			"3090000",		"kPink+1",		"DY",			"YES"},/*19*/
	{"DYJetsToLL_HT-1200to2500_2017",	"0.1514*1.23",			"625500",		"kPink+1",		"DY",			"YES"},/*20*/
	{"DYJetsToLL_HT-2500toInf_2017",	"0.003565*1.23",		"405000",		"kPink+1",		"DY",			"YES"},/*21*/
        {"WWZ_2017", 			        "0.16510",                	"250000",               "kPink-5",              "VVV",                  "YES"},/*22*/
        {"WZZ_2017",       			"0.05565",                	"249990",               "kPink-5",              "VVV",                  "YES"},/*23*/
        {"ZZZ_2017",       			"0.01398",               	"250000",               "kPink-5",              "VVV",                  "YES"},/*24*/
	{"TTTo2L2Nu_2017",			"87.31",			"8306000",		"kGray+1",		"TT",			"YES"},/*25*/
	{"WWTo2L2Nu_2017",			"12.178",			"191588",		"kTeal+2",		"WW",			"YES"},/*26*/
	{"ZZTo2L2Nu_2017",			"0.564",			"7412900",		"kOrange-2",		"ZZ",			"YES"},/*27*/
	{"WZTo3LNu_2017",			"4.42965",			"4939000",		"kAzure-4",		"WZ",			"YES"},/*28*/
	//Data 2017
...
static TString axis[] = {"M_{Z} [GeV]", "P_{T}^{miss} [GeV]", "Z P_{t} [GeV]", "#Delta#phi_{Z,P_{T}^{miss}}", "Balance", "#Delta#phi_{ll}", "#Delta#eta_{ll}", "Leading Lepton P_{T} [GeV]", "Trailing Lepton P_{T} [GeV]", "Leading Lepton #eta", "Trailing Lepton #eta", "#eta_{ll}", "Rapidity_{ll}", "# of Jets", "Leading Jet P_{t} [GeV]", "sub-Leading Jet P_{t} [GeV]", "Leading Jet #eta", "sub-Leading Jet #eta", "M_{jj} [GeV]", "#Delta#phi_{jj}", "#Delta#eta_{jj}", "# of B Jets", "xJet", "xZ", "Zeppenfeld", "Zeppenfeld_{l}^{1}", "Zeppenfeld_{l}^{2}","xMet", "H_{T} [GeV]", "P_{T}^{j1}+P_{T}^{j2}/H_{T}", "P_{T}^{j2}/P_{T}^{j1}", "#eta_{j1}*#eta_{j2}", "P_{T}^{j1}-P_{T}^{j2}/P_{T}^{Z}", "Central Jet P_{T}", "Central Jet P_{T} Sum", "P_{T}^{l1}*P_{T}^{l2}/P_{T}^{j1}*P_{T}^{j2}", "# of genjets", "#Delta#phi_{J^{1},P_{T}^{miss}}", "#Delta#phi_{J^{closest},P_{T}^{miss}}", "nVTX", " Z m_{T} [GeV]" };
