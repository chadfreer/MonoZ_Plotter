...
def test():
   ...
   for i in range(ndatasets):
      ...
      chain.Project(name, 'Z_pt', "puWeight * lumiWeight * (lep_category==2 && Z_pt>60 && met_pt>40 && Z_mass>81 && Z_mass<101 && ngood_jets<2 && ngood_bjets==0)")
   ...
   for j in range(nPDs):
      ...
      chain.Project('data', 'Z_pt', "(lep_category==2 && Z_pt>60 && met_pt>40 && Z_mass>81 && Z_mass<101 && ngood_jets<2 && ngood_bjets==0)")
