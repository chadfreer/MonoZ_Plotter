...
//        DYJetsToLL50To100->Add(DYJetsToLL650Toinf);
	...
	//DYJetsToLL_HT70to100->Add(DYJetsToLL_HT2500toInf);
        ...
        TH1D *DYJetsToLL = GethPt(fDY_2017, "Events", "DYJetsToLL_2017","DYJetsToLL_2017",Branch_count, 0);
        //TH1D *DYJetsToLL_1 = GethPt(fDY_2017_1, "Events", "DYJetsToLL_2017","DYJetsToLL_2017",Branch_count, 0);
        //DYJetsToLL->Add(DYJetsToLL_1);

	TH1D *fullMC = (TH1D*)DYJetsToLL->Clone("copy");
...
//        ZZJJ_ZZTo2L2Nu->Draw("histsame");
	...
	TH1D *DoubleEG_2017 = GetDATAhPt(fDoubleEG_2017_B, "Events", "DoubleEG_2017", "DoubleEG_2017",Branch_count, 0);
        TH1D *DoubleEG_2017_C = GetDATAhPt(fDoubleEG_2017_C, "Events", "DoubleEG_2017_C", "DoubleEG_2017_C",Branch_count, 0);
        TH1D *DoubleEG_2017_D = GetDATAhPt(fDoubleEG_2017_D, "Events", "DoubleEG_2017_D", "DoubleEG_2017_D",Branch_count, 0);
        TH1D *DoubleEG_2017_E = GetDATAhPt(fDoubleEG_2017_E, "Events", "DoubleEG_2017_E", "DoubleEG_2017_E",Branch_count, 0);
        TH1D *DoubleEG_2017_F = GetDATAhPt(fDoubleEG_2017_F, "Events", "DoubleEG_2017_F", "DoubleEG_2017_F",Branch_count, 0);
        DoubleEG_2017->Add(DoubleEG_2017_C);
        DoubleEG_2017->Add(DoubleEG_2017_D);
        DoubleEG_2017->Add(DoubleEG_2017_E);
        DoubleEG_2017->Add(DoubleEG_2017_F);

	TH1D *DoubleMuon_2017_B = GetDATAhPt(fDoubleMuon_2017_B, "Events", "DoubleMuon_2017_B", "DoubleMuon_2017_B",Branch_count, 0);
        TH1D *DoubleMuon_2017_C = GetDATAhPt(fDoubleMuon_2017_C, "Events", "DoubleMuon_2017_C", "DoubleMuon_2017_C",Branch_count, 0);
        TH1D *DoubleMuon_2017_D = GetDATAhPt(fDoubleMuon_2017_D, "Events", "DoubleMuon_2017_D", "DoubleMuon_2017_D",Branch_count, 0);
        TH1D *DoubleMuon_2017_E = GetDATAhPt(fDoubleMuon_2017_E, "Events", "DoubleMuon_2017_E", "DoubleMuon_2017_E",Branch_count, 0);
        TH1D *DoubleMuon_2017_F = GetDATAhPt(fDoubleMuon_2017_F, "Events", "DoubleMuon_2017_F", "DoubleMuon_2017_F",Branch_count, 0);
        DoubleEG_2017->Add(DoubleMuon_2017_B);
        DoubleEG_2017->Add(DoubleMuon_2017_C);
        DoubleEG_2017->Add(DoubleMuon_2017_D);
        DoubleEG_2017->Add(DoubleMuon_2017_E);
        DoubleEG_2017->Add(DoubleMuon_2017_F);

	TH1D *MuonEG_2017_B = GetDATAhPt(fMuonEG_2017_B, "Events", "MuonEG_2017_B", "MuonEG_2017_B",Branch_count, 0);
        TH1D *MuonEG_2017_C = GetDATAhPt(fMuonEG_2017_C, "Events", "MuonEG_2017_C", "MuonEG_2017_C",Branch_count, 0);
        TH1D *MuonEG_2017_D = GetDATAhPt(fMuonEG_2017_D, "Events", "MuonEG_2017_D", "MuonEG_2017_D",Branch_count, 0);
        TH1D *MuonEG_2017_E = GetDATAhPt(fMuonEG_2017_E, "Events", "MuonEG_2017_E", "MuonEG_2017_E",Branch_count, 0);
        TH1D *MuonEG_2017_F = GetDATAhPt(fMuonEG_2017_F, "Events", "MuonEG_2017_F", "MuonEG_2017_F",Branch_count, 0);
        DoubleEG_2017->Add(MuonEG_2017_B);
        DoubleEG_2017->Add(MuonEG_2017_C);
        DoubleEG_2017->Add(MuonEG_2017_D);
        DoubleEG_2017->Add(MuonEG_2017_E);
        DoubleEG_2017->Add(MuonEG_2017_F);

	TH1D *SingleElectron_2017_B = GetDATAhPt(fSingleElectron_2017_B, "Events", "SingleElectron_2017_B", "SingleElectron_2017_B",Branch_count, 0);
        TH1D *SingleElectron_2017_C = GetDATAhPt(fSingleElectron_2017_C, "Events", "SingleElectron_2017_C", "SingleElectron_2017_C",Branch_count, 0);
        TH1D *SingleElectron_2017_D = GetDATAhPt(fSingleElectron_2017_D, "Events", "SingleElectron_2017_D", "SingleElectron_2017_D",Branch_count, 0);
        TH1D *SingleElectron_2017_E = GetDATAhPt(fSingleElectron_2017_E, "Events", "SingleElectron_2017_E", "SingleElectron_2017_E",Branch_count, 0);
        TH1D *SingleElectron_2017_F = GetDATAhPt(fSingleElectron_2017_F, "Events", "SingleElectron_2017_F", "SingleElectron_2017_F",Branch_count, 0);
        DoubleEG_2017->Add(SingleElectron_2017_B);
        DoubleEG_2017->Add(SingleElectron_2017_C);
        DoubleEG_2017->Add(SingleElectron_2017_D);
        DoubleEG_2017->Add(SingleElectron_2017_E);
        DoubleEG_2017->Add(SingleElectron_2017_F);

        TH1D *SingleMuon_2017_B = GetDATAhPt(fSingleMuon_2017_B, "Events", "SingleMuon_2017_B", "SingleMuon_2017_B",Branch_count, 0);
	TH1D *SingleMuon_2017_C = GetDATAhPt(fSingleMuon_2017_C, "Events", "SingleMuon_2017_C", "SingleMuon_2017_C",Branch_count, 0);
	TH1D *SingleMuon_2017_D = GetDATAhPt(fSingleMuon_2017_D, "Events", "SingleMuon_2017_D", "SingleMuon_2017_D",Branch_count, 0);
	TH1D *SingleMuon_2017_E = GetDATAhPt(fSingleMuon_2017_E, "Events", "SingleMuon_2017_E", "SingleMuon_2017_E",Branch_count, 0);
	TH1D *SingleMuon_2017_F_1 = GetDATAhPt(fSingleMuon_2017_F_1, "Events", "SingleMuon_2017_F", "SingleMuon_2017_F",Branch_count, 0); 
        TH1D *SingleMuon_2017_F_2 = GetDATAhPt(fSingleMuon_2017_F_2, "Events", "SingleMuon_2017_F", "SingleMuon_2017_F",Branch_count, 0);
        TH1D *SingleMuon_2017_F_3 = GetDATAhPt(fSingleMuon_2017_F_3, "Events", "SingleMuon_2017_F", "SingleMuon_2017_F",Branch_count, 0);
        TH1D *SingleMuon_2017_F_4 = GetDATAhPt(fSingleMuon_2017_F_4, "Events", "SingleMuon_2017_F", "SingleMuon_2017_F",Branch_count, 0);
        TH1D *SingleMuon_2017_F_5 = GetDATAhPt(fSingleMuon_2017_F_5, "Events", "SingleMuon_2017_F", "SingleMuon_2017_F",Branch_count, 0);
        TH1D *SingleMuon_2017_F_6 = GetDATAhPt(fSingleMuon_2017_F_6, "Events", "SingleMuon_2017_F", "SingleMuon_2017_F",Branch_count, 0);
        TH1D *SingleMuon_2017_F_7 = GetDATAhPt(fSingleMuon_2017_F_7, "Events", "SingleMuon_2017_F", "SingleMuon_2017_F",Branch_count, 0);
        TH1D *SingleMuon_2017_F_8 = GetDATAhPt(fSingleMuon_2017_F_8, "Events", "SingleMuon_2017_F", "SingleMuon_2017_F",Branch_count, 0);
        TH1D *SingleMuon_2017_F_9 = GetDATAhPt(fSingleMuon_2017_F_9, "Events", "SingleMuon_2017_F", "SingleMuon_2017_F",Branch_count, 0);

        DoubleEG_2017->Add(SingleMuon_2017_B);
        DoubleEG_2017->Add(SingleMuon_2017_C);
        DoubleEG_2017->Add(SingleMuon_2017_D);
        DoubleEG_2017->Add(SingleMuon_2017_E);
        DoubleEG_2017->Add(SingleMuon_2017_F_1);
        DoubleEG_2017->Add(SingleMuon_2017_F_2);
        DoubleEG_2017->Add(SingleMuon_2017_F_3);
        DoubleEG_2017->Add(SingleMuon_2017_F_4);
        DoubleEG_2017->Add(SingleMuon_2017_F_5);
        DoubleEG_2017->Add(SingleMuon_2017_F_6);
        DoubleEG_2017->Add(SingleMuon_2017_F_7);
        DoubleEG_2017->Add(SingleMuon_2017_F_8);
        DoubleEG_2017->Add(SingleMuon_2017_F_9);
