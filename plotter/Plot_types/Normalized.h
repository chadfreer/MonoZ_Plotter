//Code to make normalized plots

TCanvas * Normalized_plots(int Branch_count) {
    ...
    */
    ...
    ZZJJ_ZZTo2L2Nu->DrawNormalized("histsame");
    /*
...
//Set up legend
	...
	leg->AddEntry(ZZTo2L2Nu,"SM Background","F");
